...
//    }
    ...
    public Map typhoonListZJWATER(Integer year){
        String url=typhoonSourceWater.getTyphoonList();
...
//        TyphoonSourceWater typhoonSourceWater=new TyphoonSourceWater();
//        TyphoonConfig typhoonConfig=new TyphoonConfig();
        String summary_year=typhoonConfig.getZjwatertyphoonList();
...
//        String url=TyphoonSourceJP.typhoonList;
        String url=typhoonSourceJP.getTyphoonInfo();
...
//    public List phoonroutesZJWATER(String tfid){
//        return null;
//    }
}
